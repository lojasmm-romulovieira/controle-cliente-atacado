            ...
            <nav className="bg-gray-600 border-b border-gray-100">
                <div className="mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex text-xl">
                                <NavLink href={route('web.cliente.index')} className="hover:bg-gray-700">
                                    <span className={"text-2xl text-white"}>Cliente</span>
                                </NavLink>
                            </div>
                        </div>
